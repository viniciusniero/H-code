...
<body>
    ...
    <header>
        ...
        <div id="menu-mobile-mask" class="d-sm-none"></div>
 
        <div id="menu-mobile" class="d-sm-none">
        ...
        <div class="header-black">
            ...
            <div class="container">
                ...
                <input type="search" id="input-search-mobile" class="d-sm-none" placeholder="search....">
